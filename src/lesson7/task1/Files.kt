...
fun countSubstrings(inputName: String, substrings: List<String>): Map<String, Int> {
    val arr = mutableListOf(emptyList<Int>().toMutableList())
    val text = File(inputName).bufferedReader()
    val vhozhd = mutableMapOf<String, Int>()
    var c = text.read()
    for (i in 0 until substrings.size) {//Готовим место под слова
        arr.add(emptyList<Int>().toMutableList())
        arr[i] = mutableListOf(-1)
